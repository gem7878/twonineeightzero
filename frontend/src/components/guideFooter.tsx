...
const GuideFooter: React.FC<GuideFooterProps> = ({
  ...
  const menuList = [
    [
      ...
      [
        '기관사 및 승무원의 안내방송에 따라 대피',
        '승무원이 승강문을 개방하면 질서 있게 대피합시다.(필요시, 비상사다리 설치) - 부상자, 노약자, 임산부가 먼저 대피할 수 있도록 배려하고 도와줍니다.',
        '승강문이 열리지 않을 때',
        '비상용 망치를 이용하여 비상창문을 깨고 탈출할 수 있습니다.',
        '터널내에서',
        '비상 유도등을 따라 가까운 터널 입구 및 비상대피소로 이동합니다. - 반대편 선로로 절대 대피하지 않도록 하고, 선로변내에 머무르지 않습니다. - 안전한 장소에서 구급차, 구원열차, 버스 등 연계수송 교통수단을 기다립니다.',
      ],
    ],
    [
      '화재사고',
      ...
      [
        ...
        '',
        '출입문이 자동으로 열리지 않을 때',
        '수동으로 문을 연다. - 비상용 망치를 이용하여 유리창을 깨고, 망치가 없으면 소화기로 유리창을 깹니다.',
        '스크린도어(PSD)가 열리지 않을 때',
        '스크린도어에 설치된 빨간색 바를 밀고 나갑니다. - 코와 입을 수건, 티슈, 옷소매 등으로 막고 비상구로 신속히 대피합시다.',
        '정전 시',
        '대피유도등을 따라 출구로 나갑니다. - 유도등이 보이지 않을 때는 벽을 짚으면서 나가거나 시각장애인 안내용 보도블록을 따라 나갑시다.',
